# wizard-vault-setup Specification

## Purpose
TBD - created by syncing change `add-playbook-wizard`. Defines the wizard's optional vault-creation step: capturing secrets with hidden input and encrypting them immediately, leaving no plaintext behind.
