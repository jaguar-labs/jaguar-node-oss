# dependency-pinning Specification

## Purpose
TBD - created by syncing change `add-ci-guardrails`. Defines how Ansible collection dependencies are declared and version-pinned so setups are reproducible across operator machines and CI.
